...
from custom_prompt import SYSTEM_PROMPT, USER_PROMPT #, FEEDBACK_SYSTEM_PROMPT, FEEDBACK_USER_PROMPT, FINAL_SYSTEM_PROMPT, FINAL_USER_PROMPT
...
def main():
    ...
    parser.add_argument("--input", default="data/test_dataset.csv", help="Input CSV path containing body_archaic_hangul column")
    parser.add_argument("--output", default="submission_300-400.csv", help="Output CSV path")
